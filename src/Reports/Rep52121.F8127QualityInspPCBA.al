report 52121 "ERF F-812-7 Quality Insp. PCBA"
{
    ApplicationArea = All;
    Caption = 'F-812-7 PCBA Quality Insp. Checklist';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports/Layouts/F8127PCBAQualityInspectionCheckList.rdl';
