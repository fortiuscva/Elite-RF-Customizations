report 52101 "ERF Sales Order Confirmation"
{
    Caption = 'ERF Sales Order Confirmation';
    RDLCLayout = './src/Reports/Layouts/ERFSOConfirmation.rdl';
    DefaultLayout = RDLC;
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    { }
                    column(Home_Caption; Home_CaptionLbl)
                    { }
                    ...
                    { }
                    column(QuoteNo_Caption; QuoteNo_CaptionLbl)
                    { }
                    column(DueDate_Caption; DueDate_CaptionLbl)
                    { }
                    column(QuoteNo_SalesHeader; "Sales Header"."Quote NO.")
                    { }
                    column(DueDate_SalesHeader; "Sales Header"."Promised Delivery Date")
                    { }
    ...
    var
        ...
        ToCaptionLbl: Label 'Bill To:';
        ShipDateCaptionLbl: Label 'Ship Date';
        CustomerIDCaptionLbl: Label 'Customer ID';
        PONumberCaptionLbl: Label 'PO #';
