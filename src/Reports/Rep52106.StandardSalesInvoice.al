...
report 52106 "ERF Standard Sales - Invoice"
{
    DefaultLayout = rdlc;
    RDLCLayout = 'src/Reports/Layouts/ERFSalesInvoice.rdl';
    Caption = 'ERF Sales - Invoice';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(DueDate_Lbl; 'Invoice Due Date')
            {
            }
            ...
            column(ExternalDocumentNo_Lbl; 'Customer PO No.')
            {
            }
    ...
    begin
        ...
        FillNameValueTable(LeftHeader, 'Invoice Due Date', Format(Header."Due Date", 0, 4));
    ...
    begin
        ...
        if not IsHandled then begin
            ...
            FillNameValueTable(RightHeader, 'Send remittance to:', 'remittance@eliterf.com');
