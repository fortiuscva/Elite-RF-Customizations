page 52101 "ERF Purchase Lines Archive"
{
        ...
        area(navigation)
        {
            group("&Line")
            {
                ...
                action("Show Document")
                {
                    ...
                    begin
                        PurchHeaderArchive.Get(Rec."Document Type", Rec."Document No.", Rec."Doc. No. Occurrence", Rec."Version No.");
                        PageManagement.PageRun(PurchHeaderArchive);
                    end;
                }
            }
        }
